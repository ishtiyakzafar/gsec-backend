import Banners from '../../../database/models/banners/index.js';
...
export function createNewBanner(req, res) {
...
export function getPaginatedBanners(req, res) {
	...
	async.parallel(
		{
			documentCounts: function(callback) {
				Banners.find().countDocuments().exec(callback);
			},
